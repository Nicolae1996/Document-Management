var site_settings = '<div class="ts-button">'
    ...
    + '</div>'
    + '<div class="ts-row" id="font-settings">'
    + '<label class="check"><span id="name">Font</span>'
    + '<div class="col-md-9">'
    + '<select class="form-control select" id="cFont">'
    + '<option value="0.95">foarte mic</option>'
    + '<option value="0.97">mic</option>'
    + '<option value="0.98">Normal</option>'
    + '<option value="1">mare</option>'
    + '<option value="1.02">foarte mare</option>'
    + '</select>'
    + '</div>'
    + '</label>'
    + '</div>'
...
$("#cFont")
    .change(function () {
        var option = $("#cFont option:selected").val();
        $("*").css("font-size", option + "em");
    })
    .change();
//End function for change font
